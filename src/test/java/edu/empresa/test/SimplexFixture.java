...
public class SimplexFixture {
	...
	public void fixture() {
		...
		aireAcondicionado = new DispositivoInteligente("Aire acondicionado", LocalDate.of(2017, 4, 28),
				fabricanteAireAcondicionado, 90.0, 360.0);
		lampara = new DispositivoInteligente("Lampara", LocalDate.of(2017, 4, 28), fabricanteLampara, 90.0, 360.0);
		televisor = new DispositivoInteligente("Televisor", LocalDate.of(2017, 4, 28), fabricanteTelevisor, 90.0,
				360.0);
		...
		ventilador = new DispositivoInteligente("Ventilador", LocalDate.of(2017, 4, 28), fabricanteVentilador, 120.0,
				360.0);
		...
		cliente = new Cliente("Melisa", "Rodriguez", TipoDocumento.DNI, "1111", "4444", "Nazca 156",
				LocalDate.of(2017, 4, 28), inteligentes, dispositivosEstandar, true, new Punto(-0.127512, 51.507222),
				null);
		cliente2 = new Cliente("Facundo", "Fraguaga", TipoDocumento.DNI, "1110", "464", "Calle Falsa 123",
				LocalDate.of(2017, 4, 27), inteligentes2, dispositivosEstandar, true, new Punto(-0.127512, 51.507222),
				null);
