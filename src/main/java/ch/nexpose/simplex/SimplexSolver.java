...
public class SimplexSolver {
    ...
    private void setProblema(SimplexProblem unProblema) {
    	this.unProblema = unProblema;
    }
    
    private void problemaAMax() {
    	if(this.unProblema.getOptimisationType() == OptimisationType.Min)
